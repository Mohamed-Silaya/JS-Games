document.addEventListener("DOMContentLoaded", () => {
    ...
    function initGame(cardsNumber) {
      ...
      for (var i = 1; i <= cardsNumber; i++) {
        i <= cardsNumber / 2 ? cardsIndex.push(i) : cardsIndex.push(i - cardsNumber / 2)
      }
      ...
      // Create card elements based on mode
      cards = []
    ...
    function checkGameEnd() {
      if (attempts.correct === Number.parseInt(selectCellsNumber.value) / 2) {
        ...
        modalTime.innerHTML = "<span>Time Spent: </span>"
        modalTime.appendChild(timerClone)
    ...
    function setupRestartGame() {
      restartBtn.onclick = () => {
        modal.style.cssText = "visibility: visible; opacity: 1; transition: opacity .5s;"
        ...
        modalContent.querySelector(".cancel-btn").onclick = () => {
          modal.style.cssText = "visibility: hidden; opacity: 0; transition: opacity .5s;"
        }
    ...
    function showHighScores() {
      ...
      scoresModal.innerHTML =
        ...
        '<h2 class="modal-heading">High Scores</h2>' +
      ...
      var scoresList = scoresModal.querySelector(".scores-list")
      ...
      scoresModal.style.cssText = "visibility: visible; opacity: 1;"
      scoresModal.querySelector(".close-btn").onclick = () => {
        scoresModal.remove()
      }
    }
